 ...
 * 2D Inverse Real FFT
 */
export function irfft2<T extends DType>(
  a: NDArray<T>,
  shape?: [number, number],
): NDArray<'float64'> {
  const data = a.getData()
 ...
 */
export function fftn<T extends DType>(
  a: NDArray<T>,
  shape?: number[],
  axes?: number[],
): NDArray<'float64'> {
 ...
 */
export function ifftn<T extends DType>(
  a: NDArray<T>,
  shape?: number[],
  axes?: number[],
): NDArray<'float64'> {
 ...
 */
export function rfftn<T extends DType>(
  a: NDArray<T>,
  shape?: number[],
  axes?: number[],
): NDArray<'float64'> {
 ...
 */
export function irfftn<T extends DType>(
  a: NDArray<T>,
  shape?: number[],
  axes?: number[],
): NDArray<'float64'> {
 ...
 * // [0, 1, 2, 3, -4, -3, -2, -1]
 */
export function fftfreq(n: number, d = 1.0): NDArray<'float64'> {
 ...
 * // [0, 1, 2, 3, 4]
 */
export function rfftfreq(n: number, d = 1.0): NDArray<'float64'> {
