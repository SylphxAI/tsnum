...
target remains `@sylphx/numpy`/`tsnum`; this package owns low-level float64 hot
...
- The package is loaded opportunistically by the tsnum native backend and falls
  back to native BLAS/TypeScript paths when unavailable.
